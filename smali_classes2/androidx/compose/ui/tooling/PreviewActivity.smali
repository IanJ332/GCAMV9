...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p1, v0}, Lrke;->s(Ljava/lang/CharSequence;C)I
    ...
    :goto_0
    invoke-static {p1}, Lrke;->A(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v7, Lcom/google/android/apps/camera/camcorder/ui/stabilization/UMXb/KUYHRKOHuHoq;->MvrONGhuuty:Ljava/lang/String;
    ...
    invoke-interface {v3}, Lbvr;->b()Lrlw;

    move-result-object v1

    invoke-interface {v3}, Lbvr;->a()I

    move-result v3

    invoke-interface {v1}, Lrlw;->a()Ljava/util/Iterator;
    ...
    invoke-direct {v4, v1}, Lrmb;-><init>(I)V

    invoke-interface {v3}, Lrlw;->a()Ljava/util/Iterator;
    ...
    invoke-interface {v4, v1}, Lrji;->a(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v7

    :goto_6
    invoke-static {v7}, Lqju;->N(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    new-instance v3, Ljava/util/ArrayList;

    invoke-static {v1}, Lqju;->ao(Ljava/lang/Iterable;)I
    ...
    throw p1
    :try_end_1
    .catch Lriw; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-direct {v1, v4, v0, p1, v5}, Lbvq;-><init>([Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;I)V

    const p1, -0x6776ed02

    invoke-static {p1, v5, v1}, Lsy;->m(IZLjava/lang/Object;)Laxi;

    move-result-object p1

    invoke-static {p0, p1}, Lpl;->a(Loy;Lrjm;)V
    ...
    invoke-direct {v1, v0, p1, v4, v2}, Lbvq;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;I)V
    ...
    invoke-direct {v1, v0, p1, v2, v4}, Laeq;-><init>(Ljava/lang/Object;Ljava/lang/Object;I[B)V
