...
.method public static FIX_SENSOR_INFO_ACTIVE_ARRAY(Landroid/graphics/Rect;Llvp;)Landroid/graphics/Rect;
    .locals 1
    ...
    invoke-interface {p1, p0}, Llvp;->n(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public static createCaptureRequest(Landroid/hardware/camera2/CameraDevice;I)Lluz;
    ...
    const-string p0, "pref_metering_mode_key"
...
.method public static getMaxZoom(Llvo;)F
    ...
    invoke-virtual {p0, v0, v2}, Llvo;->m(Landroid/hardware/camera2/CameraCharacteristics$Key;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static isBinnedTelephoto(Llzv;)Z
    .locals 3
...
.method public static mergeSetting(Lcom/google/googlex/gcam/ShotParams;Lddf;)V
    ...
    sput v6, Lcom/agc/LogData$Device;->mergeMethod:I
...
.method public static onClickOptionsMenu(Lgtv;)Z
    ...
    const-string p0, "hdrnet_enabled"

    invoke-static {p0, v1}, Lcom/Utils/Pref;->getBooleanValue(Ljava/lang/String;Z)Z

    move-result v0

    xor-int/2addr v0, v2

    invoke-static {p0, v0}, Lcom/Utils/Pref;->setBooleanValue(Ljava/lang/String;Z)V
...
.method public static setDeveloperSettings()V
    ...
    invoke-virtual {v0, v1, v4}, Ldep;->u(Lddg;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v4}, Ldep;->o(Lddi;Ljava/lang/Integer;)V
    ...
    invoke-static {v0, v3}, Lcom/Utils/Pref;->getBooleanValue(Ljava/lang/String;Z)Z
...
.method public static setDeveloperSettingsNonPixel()V
    ...
    sget-object v1, LAGC;->gcaConfig:Ldep;
    ...
    invoke-virtual {v1, v2, v3}, Ldep;->s(Lddg;Z)V
    ...
    sget-object v2, Lddl;->aR:Lddg;

    invoke-virtual {v0}, Lcom/agc/Camera;->isLogical()Z

    move-result v0

    invoke-virtual {v1, v2, v0}, Ldep;->s(Lddg;Z)V
