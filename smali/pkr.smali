...
.method public static y(Llvp;Llvq;Llzv;)Llvp;
    .locals 6
    .param p0, "cameraDeviceCharacteristics"    # Llvp;
    .param p1, "cameraHardwareManager"    # Llvq;
...
.method public final m(Llzv;Lcom/google/googlex/gcam/GyroSampleVector;Ljava/util/Map;)Lcom/google/googlex/gcam/FrameMetadata;
    ...
    invoke-static {v11, v2}, Lcom/agc/LensSettings;->getBlackLevel(Llvp;Llzv;)[F

    move-result-object v3

    if-eqz v4, :cond_20

    invoke-static {v3, v4}, Lcom/agc/LensSettings;->getCorrectionBlackLevelDynamic([F[F)[F
...
.method public final w(Lcom/google/googlex/gcam/AeShotParams;Llzv;FLlig;)V
    ...
    invoke-static {v3}, LAGC;->FIX_SCALER_CROP_REGION(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v5, v2}, LAGC;->FIX_SENSOR_INFO_ACTIVE_ARRAY(Landroid/graphics/Rect;Llvp;)Landroid/graphics/Rect;
